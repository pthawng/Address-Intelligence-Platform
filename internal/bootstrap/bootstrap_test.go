...
func runtimeEnvironment(t *testing.T) {
	...
	for _, key := range []string{
		...
		"HTTP_ADDRESS", "HTTP_PORT", "HTTP_READ_HEADER_TIMEOUT", "HTTP_READ_TIMEOUT", "HTTP_WRITE_TIMEOUT", "HTTP_IDLE_TIMEOUT", "HTTP_MAX_HEADER_BYTES", "HTTP_REQUEST_TIMEOUT", "HTTP_CORS_ORIGINS", "HTTP_RATE_PER_SECOND", "HTTP_RATE_BURST",
	} {
		t.Setenv(key, "")
	}
